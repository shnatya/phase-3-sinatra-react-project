...
Joke.create(question: "Who always comes to a picnic but is never invited?", answer: "ants", user_id: 1)
Joke.create(question: "What do you call an alligator with a vest?", answer: "an_investigator", user_id: 1)
Joke.create(question: "What kind of button won’t unbutton?", answer: "a_belly_button", user_id: 2)
Joke.create(question: "What starts and ends with an E but contains only one letter?", answer: "an_envelope", user_id: 2)
Joke.create(question: "What do you call a dinosaur that is sleeping", answer: "a_dino_snore", user_id: 3)
Joke.create(question: "What is a vampire’s favorite fruit?", answer: "a_blood_orange", user_id: 3)
Joke.create(question: "What is a witch’s favorite subject in school?", answer: "spelling", user_id: 4)
Joke.create(question: "What sound do hedgehogs make when they hug?", answer: "ouch", user_id: 4)
